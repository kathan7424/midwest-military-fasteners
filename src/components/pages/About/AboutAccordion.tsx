      ...
      {items.map((item, idx) => (
        <AccordionPrimitive.Item key={idx} className="mb-5 last:mb-0">
          <AccordionPrimitive.Header className="flex">
            <AccordionPrimitive.Trigger className="group relative flex flex-1 items-center justify-between gap-2 bg-[#FAFAFA] px-6 py-4 text-left text-lg font-normal text-[#336699] hover:bg-[#f3f3f3] aria-disabled:pointer-events-none aria-disabled:opacity-50">
              {item.question}
